...
class Jpeg_255(JpegBasic):
	def __init__(self, Q, subsample=0):
		super(Jpeg_255, self).__init__()
...
class Jpeg_DCT(JpegBasic):
	...
	def forward(self, image_and_cover):
		...
		# reverse quantization
		image_quantization_r = self.std_reverse_quantization(image_quantization, self.scale_factor)

		# idct, yuv2rgb, [0,255] to [-1,1]
		#noised_image = self.idct_rgb(image_quantization, pad_width, pad_height)
		return image_dct,image_quantization_r

class Jpeg_GET(JpegBasic):
	def __init__(self, subsample=0):
		super(Jpeg_GET, self).__init__()

	def forward(self, image_quantization):
		noised_image = self.idct_rgb(image_quantization, 0, 0)
		return noised_image
...
class JpegSS_255(JpegBasic):
	def __init__(self, Q, subsample=0):
		super(JpegSS_255, self).__init__()
...
class JpegMask_255(JpegBasic):
	def __init__(self, Q, subsample=0):
		super(JpegMask_255, self).__init__()
